...
$colorSpec = array(
    "\x02" => array(255,255,255), // 0     
    "\x03" => array(0,0,0),       // 1
    "\xc0" => array(255,255,255),     //marker 0   
    "\xc1" => array(150,188,51),     //marker 1
    "\xa0" => array(255,255,255),   //submarker 0
    "\xa1" => array(255,0,0),   //submarker 1
    "\x84" => array(255,255,255),     //format 0
    "\x85" => array(0,0,0),     //format 1
    "\x81" => array(255,255,255),   //special bit
    "\x90" => array(255,255,255),   //clock 0
    "\x91" => array(0,0,0),   //clock 1
    "\x88" => array(255,255,255),     //version 0 
    "\x89" => array(0,0,0)      //version 1
);
...
$target_image = imagecreate(
    $imgW * $pixelPerPoint, // + 150 , Ein- oder Ausblenden der Legende
